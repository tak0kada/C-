...
## [第6章](http://www.asahi-net.or.jp/~yf8k-kbys/newcpp6.html)
第6章はクラスの文法について
```cpp
// 全部入りクラス
class Person {
...
## [第7章](http://www.asahi-net.or.jp/~yf8k-kbys/newcpp7.html)
第7章は条件分岐について
* if、else
```cpp
if (a < b)
...
## [第8章](http://www.asahi-net.or.jp/~yf8k-kbys/newcpp8.html)
第8章は関数のオーバーロードについて
...
```
## [第10章](http://www.asahi-net.or.jp/~yf8k-kbys/newcpp10.html)
